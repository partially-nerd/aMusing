...
const here = `C:\\Users\\${USRNAME}\\Desktop\\aMusing\\audio\\`
...
const searchOnline = async(e) => {
    if (e.key == "Enter") {
        ...
        setTimeout(() => {
            res = res.items[0].id;
            child_process.spawn(`powershell -file C:\\Users\\${USRNAME}\\Desktop\\aMusing\\dist\\ytdlp.ps1 https://www.youtube.com/watch?v=${res}`)
